                 ...
                 return(
                     <Col className=" p-1 " md={4} lg={4} sm={12} xs={12}>
                         <Card className="notification-card">
                             <Card.Body>
                                 <h6> {Mylist.title}</h6>
                                 <p className="py-1  px-0 text-primary m-0"><i className="fa  fa-bell"></i>  {moment(Mylist.created_at).format('DD/MM/YYYY')}</p>
                                 <button data-msg={Mylist.msg} data-date={moment(Mylist.created_at).format('DD/MM/YYYY')} data-title={Mylist.title} onClick={this.handleShow} className="btn site-btn btn-sm">Details</button>
                             </Card.Body>
                         </Card>
                     </Col>
                 )
